...
#+Title: Meow Emacs Kickstarter
#+Author: MiniApollo revised by Paul Harper 
#+Description: A starting point for Gnu Emacs with good defaults, meow modal keybindings, and packages that most people may want to use.
...
- [[#modal-editing][Modal Editing]]
  - [[#meow][Meow]]
  - [[#meow-keybinds-macro][Meow Keybinds Macro]]
  - [[#meow-define-keymap][Meow Define Keymap]]
...
* Appearance
** Set Theme
Using Prot's modus-themes. Set to toggle a light and dark variant. Prefered starting theme is set by :init. 
#+begin_src emacs-lisp
